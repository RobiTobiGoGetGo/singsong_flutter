...
git add .
git commit -m "Auto-Release v1.0.48+49"
...
if ($LASTEXITCODE -ne 0) {
    Write-Host "PUSH FAILED! GitHub might be having temporary issues (Error 500)." -ForegroundColor Red
    exit
}

Write-Host "SUCCESS! v1.0.48+49 is now on GitHub." -ForegroundColor Green
